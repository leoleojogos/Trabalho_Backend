...
- Usa um SGBD diferente do H2 (ex: MongoDB, MySQL, PostgreSQL); (talvez SQLite)
- Integra dados de uma API externa relevante para o tema escolhido; (conversão monetária)
...
![caso de uso](./docs/entregas/entrega02/img-exemplos/caso-de-uso.png)
...
![modelo físico](./docs/entregas/entrega02/img-exemplos/banco.png)

## Mais informações 

- [Endpoints](./GUIA_GET_ENDPOINTS.md)
- [Guia de fluxo](GUIA_FLUXOS_COMPLETOS.md)
